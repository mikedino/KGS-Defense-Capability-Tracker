...
- Capability detail view with Overview, Supporting Info, Tagging, Supporting Contract(s), and Documentation tabs.
...
- Contract metadata support for contract type and USD contract value.
- Contract-specific capability summaries for each contract/capability relationship.
...
| CMS contracts | `/sites/cms` / `Contracts` | Supplemental contract lookup data |
...
- Document type, contract document type, and contract type options come from configuration values.
