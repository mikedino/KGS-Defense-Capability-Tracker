...
import type { IConfigurationItem } from "../data/props";
...
const knownConfigTypes: { key: string; displayName: string }[] = [
    { key: "appStatus", displayName: "App Status" },
    { key: "managingGroup", displayName: "Managing Group" },
    { key: "supportTeam", displayName: "Contractor Name" },
    { key: "connectivity", displayName: "Connectivity" },
    { key: "platform", displayName: "Platform" },
    { key: "environment", displayName: "Hosting Environment" },
    { key: "contractTeam", displayName: "Contract Lead" }
];
